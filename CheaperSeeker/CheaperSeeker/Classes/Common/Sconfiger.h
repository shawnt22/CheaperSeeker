...
#define k_text_copy_coupon_code_success                 @"Copy Coupon Code Success"
...
#define k_text_email_me_later_description               @"Enter your email address to receive the hottest deals, our best coupons & exclusive offers!"
